  ...
  return (
    <section className="bg-bg-dark bg-felt px-5 py-12 sm:px-8 sm:py-16 md:px-15 md:py-20">
      <div className="mx-auto flex w-full max-w-7xl flex-col items-stretch gap-8 lg:flex-row lg:items-center lg:gap-12">
        <div className="relative aspect-video w-full shrink-0 overflow-hidden rounded-2xl shadow-md lg:aspect-4/5 lg:w-[48%]">
          <Image
            src="/features.jpg"
        ...
        <div className="flex w-full flex-col items-start gap-5 lg:w-[52%]">
