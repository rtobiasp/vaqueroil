...
export default function CtaBanner({
  ...
  return (
    <section
      aria-label={title}
      className="bg-bg-dark bg-felt px-5 py-12 sm:px-8 sm:py-16 md:px-15 md:py-20"
    >
      <Reveal y={32}>
        <div className="mx-auto flex w-full max-w-7xl flex-col items-start gap-6 rounded-2xl bg-accent-primary p-6 text-bg-dark sm:p-8 lg:flex-row lg:items-center lg:justify-between lg:p-12">
          ...
          <div className="flex w-full flex-col gap-3 sm:w-auto sm:flex-row sm:flex-wrap sm:items-center lg:flex-col lg:items-stretch">
            ...
            <a
              ...
              className="flex items-center justify-center gap-2 rounded-lg bg-text-inverse px-4 py-3 text-sm font-medium text-accent-primary-hover transition hover:bg-bg-dark hover:text-text-inverse"
            >
